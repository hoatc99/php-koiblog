...
<head>
    ...
    ================================================== -->
    <meta charset="utf-8">
    <title>My Blog | <?php echo $blogMetaTitle; ?></title>
    ...
    <script>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data == 'success') {
                            ...
                            $('#comment-error').css('display', 'block');
                            $('#comment-error').html('There was an error while adding you comment. Please try again later.');
                        }
                    }
                });
        ...
        $(document).on('submit', '#replyForm', function(e) {
            ...
            if (!name || !email || !reply) {
                ...
                $('#reply-error').css('display', 'block');
                $('#reply-error').html('There was an unexpected error. Try refershing the page.');
            } else {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data == 'success') {
                            ...
                            $('#reply-error').css('display', 'block');
                            $('#reply-error').html('There was an error while adding you reply. Please try again later.');
                        }
                    }
                });
