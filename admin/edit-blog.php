...
<head>
    ...
    <title>KOI Admin | Edit Blog</title>
	<!-- Bootstrap Styles-->
                ...
                <?php
                    ...
                    if (isset($_REQUEST['updateblog'])) {
                        if ($_REQUEST['updateblog'] == 'emptytitle') {
                            ...
                            echo 
                                "<div class='alert alert-danger'>
                                    <strong>Error!</strong> Alternate Image -> Upload only jpg, jpeg, png, gif, bmp images.
                                </div>";
                            ...
                            echo 
                                "<div class='alert alert-danger'>
                                    <strong>Error!</strong> An unexpected error occurred while trying to set a home page placement. Please try again. 
                                </div>";
                        }
                    }
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                        ...
                                        <form role="form" method="POST" action="includes/update-blog.php" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <?php 
                                                    ...
                                                    if (!empty($mainImgUrl)) {
                                                        echo "<p style='font-size: inherit;'><a href='' data-toggle='modal' data-target='#main-img' class='popup-button' style='margin-top: 10px'>View Existing Image</a></p>";
                                                    }
                                            ...
                                            <div class="form-group">
                                                ...
                                                <?php 
                                                    ...
                                                    if (!empty($altImgUrl)) {
                                                        echo "<p style='font-size: inherit;'><a href='' data-toggle='modal' data-target='#alt-img' class='popup-button' style='margin-top: 10px'>View Existing Image</a></p>";
                                                    }
                                            ...
                                            <div class="form-group">
                                                <label>Blog Tags (separate by comma)</label>
                                                <input class="form-control" name="blog-tags" value="<?php echo $_SESSION['editTags']; ?>">
                                            </div>
                                            <div class="form-group">
                                                <label>Blog Path (lower case, no spaces)</label>
                                                <div class="input-group">
                                                    <span class="input-group-addon">https://koiblog.herokuapp.com/</span>
                                ...
                                <div class="modal fade" id="main-img" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <form role="form" method="POST" action="includes/delete-blog-post.php">
                                ...
                                <div class="modal fade" id="alt-img" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
